...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default=os.environ.get("SM_CHANNEL_MODEL", "/data/ephemeral/home/level1-imageclassification-cv-05/NoBellReal/v2/model/exp"),
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default=os.environ.get("SM_OUTPUT_DATA_DIR", "/data/ephemeral/home/level1-imageclassification-cv-05/NoBellReal/v2/output"),
    )
